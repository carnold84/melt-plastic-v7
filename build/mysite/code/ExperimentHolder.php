...
class ExperimentHolder extends Page {
	...
	*/
    ...
    {
    	if($this->ItemsAsChildren && (Controller::curr() instanceof ExperimentHolder_Controller))
		{
...
class ExperimentHolder_Controller extends Page_Controller {
	...
	private static $item_class = 'Experiment';
	 ...
	 * 
	 * Uses ExperimentHolder_show.ss by default
	 */
